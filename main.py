...
app = FastAPI(title='Backstract Generated APIs - coll-366557ed8b084d599ccc8972f79baa5b', debug=False,
              docs_url='/beautiful-mcnulty-8a93ab8cfe6911ef92110242ac12000545/docs',
              openapi_url='/beautiful-mcnulty-8a93ab8cfe6911ef92110242ac12000545/openapi.json')
...
app.include_router(
    router,
    prefix='/beautiful-mcnulty-8a93ab8cfe6911ef92110242ac12000545/api',
    tags=['APIs v1']
)
